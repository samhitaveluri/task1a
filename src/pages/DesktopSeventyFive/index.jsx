  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Discover expert doctors for in-clinic and video consultations at SeventyFive. Select by location, expertise, or fees. Book your session with top specialists today."
        />
      </Helmet>
      ...
      <div className="w-full bg-white-A700 pb-[303px] md:pb-5">
        ...
        <header className="flex items-end justify-between gap-5 bg-orange-50 p-[15px] md:flex-col">
          ...
          <div className="mr-[89px] mt-2 flex gap-4 md:mr-0 ">
            <Button className="flex h-[56px] min-w-[118px] items-center justify-center rounded-[11px] border border-solid border-green-800 bg-orange-50 px-[29px] text-center font-dinpro text-2xl font-medium text-green-800 sm:px-5 hover:font-bold hover:!text-green-800">
              Login
            </Button>
            ...
            <div className="mx-auto flex w-full max-w-[965px] justify-between gap-5 self-end md:flex-col">
              <div className="flex w-[80%] justify-between gap-5 md:w-full">
                <select value={selects1} onChange={e=>setSelects1(e.target.value)}
                  ...
                  className="flex w-[52%] gap-px rounded-[7px] bg-gray-100 py-[9px] pl-[13px] pr-[35px] font-dinpro text-base font-medium text-gray-700 sm:pr-5"
                  > 
                  ...
                  <select value={selects3} onChange={e=>setSelects3(e.target.value)}
                  indicator={
                    <Img src="images/img_arrowdown_gray_600_03.svg" alt="arrow_down" className="h-[5px] w-[12px]" />
                  }
                  className="flex w-[52%] gap-px rounded-[7px] bg-gray-100 py-[9px] pl-[13px] pr-[35px] font-dinpro text-base font-medium text-gray-700 sm:pr-5"
                  ...
                  <select value={selects4} onChange={e=>setSelects4(e.target.value)}
                  indicator={
                    <Img src="images/img_arrowdown_gray_600_03.svg" alt="arrow_down" className="h-[5px] w-[12px]" />
                  }
                  className="flex w-[52%] gap-px rounded-[7px] bg-gray-100 py-[9px] pl-[13px] pr-[35px] font-dinpro text-base font-medium text-gray-700 sm:pr-5"
                  ...
                  <select value={selects5} onChange={e=>setSelects5(e.target.value)}
                  indicator={
                    <Img src="images/img_arrowdown_gray_600_03.svg" alt="arrow_down" className="h-[5px] w-[12px]" />
                  }
                  className="flex w-[52%] gap-px rounded-[7px] bg-gray-100 py-[9px] pl-[13px] pr-[35px] font-dinpro text-base font-medium text-gray-700 sm:pr-5"
